(function() {
        ...
        return A3(
            ...
            F3(
                function(key, value, list) {
                    return A2(
                        _elm_lang$core$List_ops['::'], { ctor: '_Tuple2', _0: key, _1: value },
                        list);
                }),
            _elm_lang$core$Native_List.fromArray(
                []),
    ...
    var _elm_lang$core$Dict$partition = F2(
        function(predicate, dict) {
            ...
            return A3(
                _elm_lang$core$Dict$foldl,
                add, { ctor: '_Tuple2', _0: _elm_lang$core$Dict$empty, _1: _elm_lang$core$Dict$empty },
                dict);
        });
    ...
    var _elm_lang$html$Html_Events$onSubmitOptions = _elm_lang$core$Native_Utils.update(
        _elm_lang$html$Html_Events$defaultOptions, { preventDefault: true });
    ...
    var _user$project$Picker$end = _elm_lang$core$Native_Platform.incomingPort(
        'end',
        _elm_lang$core$Json_Decode$null({ ctor: '_Tuple0' }));
    ...
    var _user$project$Picker$main = {
        main: _elm_lang$html$Html_App$programWithFlags({ init: _user$project$Picker$init, view: _user$project$Picker$view, update: _user$project$Picker$update, subscriptions: _user$project$Picker$subscriptions }),
                            ...
                            return A2(
                                ...
                                function(url) {
                                    return A2(
                                        ...
                                        function(version) {
                                            return _elm_lang$core$Json_Decode$succeed({ name: name, optimized: optimized, url: url, version: version });
                                        });
                                });
                        });
                }))
