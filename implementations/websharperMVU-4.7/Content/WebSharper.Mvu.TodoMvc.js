...
{
 "use strict";
 var TodoMvc,Client,WebSharper,Operators,Mvu,App,TodoList,Model,Obj,UI,Var$1,EndPoint,WebSharper$Mvu$TodoMvc_Router,WebSharper$Mvu$TodoMvc_JsonEncoder,WebSharper$Mvu$TodoMvc_JsonDecoder,WebSharper$Mvu$TodoMvc_Templates,Entry,Message,Message$1,Model$1,List,T,View,Arrays,Templating,Runtime,Server,ProviderBuilder,Handler,Event,UIEvent,AttrModule,Router,Var,Option,Abbrev,Fresh,Numeric,Sitelets,RouterOperators,ClientSideJson,Provider,Seq,JavaScript,Pervasives,Snap,TemplateInstance,FromView,Unchecked,System,Guid,Collections,List$1,Attrs,DomUtility,RouterModule,Route,JS,EventTarget,Node,WindowOrWorkerGlobalScope,Router$1,List$2,Object,ConcreteVar,Enumerator,T$1,Doc,AttrProxy,DynamicAttrNode,Utils,Strings,Concurrency,SC$1,FSharpMap,Dictionary,HashSet,TemplateInitializer,CheckedInput,Client$1,Templates,Array,Docs,Map,Lazy,BalancedTree,Tree,Pair,DictionaryUtil,LazyExtensionsProxy,LazyRecord,Scheduler,PathUtil,Queue,DocElemNode,CharacterData,SC$2,Prepare,Slice,Elt,An,Settings,Mailbox,SC$3,MapUtil,SC$4,Attrs$1,Dyn,Updates,ValueCollection,Docs$1,RunState,NodeSet,Anims,SC$5,BindVar,String,KeyCollection,CT,CancellationTokenSource,AsyncBody,HashSetUtil,SC$6,SC$7,AppendList,Char,Easing,HashSet$1,DomNodes,Error,OperationCanceledException,SC$8,IntelliFactory,Runtime$1,JSON,RemoteDev,console,Math,Date;
 ...
 WebSharper$Mvu$TodoMvc_Router=Global.WebSharper$Mvu$TodoMvc_Router=Global.WebSharper$Mvu$TodoMvc_Router||{};
 WebSharper$Mvu$TodoMvc_JsonEncoder=Global.WebSharper$Mvu$TodoMvc_JsonEncoder=Global.WebSharper$Mvu$TodoMvc_JsonEncoder||{};
 WebSharper$Mvu$TodoMvc_JsonDecoder=Global.WebSharper$Mvu$TodoMvc_JsonDecoder=Global.WebSharper$Mvu$TodoMvc_JsonDecoder||{};
 WebSharper$Mvu$TodoMvc_Templates=Global.WebSharper$Mvu$TodoMvc_Templates=Global.WebSharper$Mvu$TodoMvc_Templates||{};
 ...
 {
  var x,x$1,r,r$1;
  App.Run((x=(x$1=App.CreateSimple(Model.get_Empty(),TodoList.Update,function(d)
  {
   return function(s)
   {
    return TodoList.Render(d,s);
   };
  }),(r=WebSharper$Mvu$TodoMvc_Router.r(),App.withRouting(Var$1.Lens(x$1.Var,function(model)
  {
  ...
  }),r,function(model)
  {
   ...
   Encode:WebSharper$Mvu$TodoMvc_JsonEncoder.j(),
   Decode:WebSharper$Mvu$TodoMvc_JsonDecoder.j()
  },{
   Encode:WebSharper$Mvu$TodoMvc_JsonEncoder.j$2(),
   Decode:WebSharper$Mvu$TodoMvc_JsonDecoder.j$2()
 ...
 App.withRemoteDev=function(msgSerializer,modelSerializer,options,app)
 {
  ...
  function update(dispatch,msg,model)
  {
   ...
   if(newModel==null)
    ...
    rdev.send(msgSerializer.Encode(msg),modelSerializer.Encode(newModel.$0));
   return newModel;
  }
 ...
 {
  var countNotCompleted,builder,C,_this,C$1,_this$1,C$2,_this$2,I,_this$3,t,v,_this$4,v$1,_this$5,t$1,E,_this$6,p;
  ...
  builder=(C=AttrModule.DynamicClassPred("selected",View.Map(function($1)
  {
   return $1.EndPoint.$===2;
  },state)),(_this=(C$1=AttrModule.DynamicClassPred("selected",View.Map(function($1)
  {
   return $1.EndPoint.$===1;
  },state)),(_this$1=(C$2=AttrModule.DynamicClassPred("selected",View.Map(function($1)
  {
   return $1.EndPoint.$===0;
  },state)),(_this$2=(I=View.Map(function($1)
  {
   return $1===1?"1 item left":Global.String($1)+" items left";
  },countNotCompleted),(_this$3=(t=(v=View.Map(function($1)
  {
   return $1.NewTask;
  },state),(_this$4=(v$1=View.Map(function($1)
  {
   return $1===0;
  },countNotCompleted),(_this$5=(t$1=(E=Doc.ConvertSeqBy(Entry.KeyOf,function(key)
  {
  ...
  {
   return x.Entries;
  },state)),(_this$6=new ProviderBuilder.New$1(),(_this$6.h.push({
   $:0,
   $0:"entries",
   $1:E
  }),_this$6))),(t$1.h.push(Handler.EventQ2(t$1.k,"clearcompleted",function()
  {
   return t$1.i;
  },function()
  {
  ...
  }),_this$4))),(t.h.push(Handler.EventQ2(t.k,"edit",function()
  {
   return t.i;
  },function(e)
  {
  ...
  p=Handler.CompleteHoles(builder.k,builder.h,[["task",0],["iscompleted",2]]);
 ...
 WebSharper$Mvu$TodoMvc_Router.r=function()
 {
  return RouterOperators.JSUnion(void 0,[[null,[[null,[]]],[]],[null,[[null,["active"]]],[]],[null,[[null,["completed"]]],[]]]);
 };
 WebSharper$Mvu$TodoMvc_JsonEncoder.j=function()
 {
  return WebSharper$Mvu$TodoMvc_JsonEncoder._v?WebSharper$Mvu$TodoMvc_JsonEncoder._v:WebSharper$Mvu$TodoMvc_JsonEncoder._v=(Provider.EncodeUnion(void 0,"type",[["EditNewTask",[["$0","text",Provider.Id(),0]]],["AddEntry",[]],["ClearCompleted",[]],["SetAllCompleted",[["$0","completed",Provider.Id(),0]]],["EntryMessage",[["$0","key",Provider.Id(),0],["$1","message",WebSharper$Mvu$TodoMvc_JsonEncoder.j$1,0]]]]))();
 };
 WebSharper$Mvu$TodoMvc_JsonDecoder.j=function()
 {
  return WebSharper$Mvu$TodoMvc_JsonDecoder._v?WebSharper$Mvu$TodoMvc_JsonDecoder._v:WebSharper$Mvu$TodoMvc_JsonDecoder._v=(Provider.DecodeUnion(void 0,"type",[["EditNewTask",[["$0","text",Provider.Id(),0]]],["AddEntry",[]],["ClearCompleted",[]],["SetAllCompleted",[["$0","completed",Provider.Id(),0]]],["EntryMessage",[["$0","key",Provider.Id(),0],["$1","message",WebSharper$Mvu$TodoMvc_JsonDecoder.j$1,0]]]]))();
 };
 WebSharper$Mvu$TodoMvc_JsonEncoder.j$2=function()
 {
  return WebSharper$Mvu$TodoMvc_JsonEncoder._v$2?WebSharper$Mvu$TodoMvc_JsonEncoder._v$2:WebSharper$Mvu$TodoMvc_JsonEncoder._v$2=(Provider.EncodeRecord(void 0,[["EndPoint",WebSharper$Mvu$TodoMvc_JsonEncoder.j$3,0],["NewTask",Provider.Id(),0],["Entries",Provider.EncodeList(WebSharper$Mvu$TodoMvc_JsonEncoder.j$4),0],["NextKey",Provider.Id(),0]]))();
 };
 WebSharper$Mvu$TodoMvc_JsonDecoder.j$2=function()
 {
  return WebSharper$Mvu$TodoMvc_JsonDecoder._v$2?WebSharper$Mvu$TodoMvc_JsonDecoder._v$2:WebSharper$Mvu$TodoMvc_JsonDecoder._v$2=(Provider.DecodeRecord(void 0,[["EndPoint",WebSharper$Mvu$TodoMvc_JsonDecoder.j$3,0],["NewTask",Provider.Id(),0],["Entries",Provider.DecodeList(WebSharper$Mvu$TodoMvc_JsonDecoder.j$4),0],["NextKey",Provider.Id(),0]]))();
 };
 WebSharper$Mvu$TodoMvc_JsonEncoder.j$1=function()
 {
  return WebSharper$Mvu$TodoMvc_JsonEncoder._v$1?WebSharper$Mvu$TodoMvc_JsonEncoder._v$1:WebSharper$Mvu$TodoMvc_JsonEncoder._v$1=(Provider.EncodeUnion(void 0,"type",[["Remove",[]],["StartEdit",[]],["Edit",[["$0","text",Provider.Id(),0]]],["CommitEdit",[]],["CancelEdit",[]],["SetCompleted",[["$0","completed",Provider.Id(),0]]]]))();
 };
 WebSharper$Mvu$TodoMvc_JsonDecoder.j$1=function()
 {
  return WebSharper$Mvu$TodoMvc_JsonDecoder._v$1?WebSharper$Mvu$TodoMvc_JsonDecoder._v$1:WebSharper$Mvu$TodoMvc_JsonDecoder._v$1=(Provider.DecodeUnion(void 0,"type",[["Remove",[]],["StartEdit",[]],["Edit",[["$0","text",Provider.Id(),0]]],["CommitEdit",[]],["CancelEdit",[]],["SetCompleted",[["$0","completed",Provider.Id(),0]]]]))();
 };
 WebSharper$Mvu$TodoMvc_JsonEncoder.j$3=function()
 {
  return WebSharper$Mvu$TodoMvc_JsonEncoder._v$3?WebSharper$Mvu$TodoMvc_JsonEncoder._v$3:WebSharper$Mvu$TodoMvc_JsonEncoder._v$3=(Provider.EncodeUnion(void 0,"$",[[0,[]],[1,[]],[2,[]]]))();
 };
 WebSharper$Mvu$TodoMvc_JsonEncoder.j$4=function()
 {
  return WebSharper$Mvu$TodoMvc_JsonEncoder._v$4?WebSharper$Mvu$TodoMvc_JsonEncoder._v$4:WebSharper$Mvu$TodoMvc_JsonEncoder._v$4=(Provider.EncodeRecord(void 0,[["Id",Provider.Id(),0],["Task",Provider.Id(),0],["IsCompleted",Provider.Id(),0],["Editing",Provider.Id(),1]]))();
 };
 WebSharper$Mvu$TodoMvc_JsonDecoder.j$3=function()
 {
  return WebSharper$Mvu$TodoMvc_JsonDecoder._v$3?WebSharper$Mvu$TodoMvc_JsonDecoder._v$3:WebSharper$Mvu$TodoMvc_JsonDecoder._v$3=(Provider.DecodeUnion(void 0,"$",[[0,[]],[1,[]],[2,[]]]))();
 };
 WebSharper$Mvu$TodoMvc_JsonDecoder.j$4=function()
 {
  return WebSharper$Mvu$TodoMvc_JsonDecoder._v$4?WebSharper$Mvu$TodoMvc_JsonDecoder._v$4:WebSharper$Mvu$TodoMvc_JsonDecoder._v$4=(Provider.DecodeRecord(void 0,[["Id",Provider.Id(),0],["Task",Provider.Id(),0],["IsCompleted",Provider.Id(),0],["Editing",Provider.Id(),1]]))();
 };
 WebSharper$Mvu$TodoMvc_Templates.entry=function(h)
 {
 ...
 {
  var b,t,t$1,v,_this,t$2,t$3,v$1,_this$1,C,_this$2,L,_this$3,p,i;
  return(b=(t=(t$1=(v=View.Map(function($1)
  {
   return $1.IsCompleted;
  },entry),(_this=(t$2=(t$3=(v$1=View.Map(function($1)
  {
   var o;
   o=$1.Editing;
   return o==null?"":o.$0;
  },entry),(_this$1=(C=[AttrModule.DynamicClassPred("completed",View.Map(function($1)
  {
   return $1.IsCompleted;
  ...
  },endpoint,entry))],(_this$2=(L=Doc.TextView(View.Map(function($1)
  {
   return $1.Task;
  },entry)),(_this$3=new ProviderBuilder.New$1(),(_this$3.h.push({
   $:0,
   $0:"label",
   $1:L
  }),_this$3))),(_this$2.h.push({
  ...
  }),_this$1))),(t$3.h.push(Handler.EventQ2(t$3.k,"editblur",function()
  {
   return t$3.i;
  },function()
  {
   dispatch(Message.CommitEdit);
  })),t$3)),(t$2.h.push(Handler.EventQ2(t$2.k,"editkeyup",function()
  {
   return t$2.i;
  },function(e)
  {
   ...
   if(m==="Enter")
    ...
    m==="Escape"?dispatch(Message.CancelEdit):void 0;
  })),t$2)),(_this.h.push({
   $:9,
   $0:"iscompleted",
  ...
  }),_this))),(t$1.h.push(Handler.EventQ2(t$1.k,"remove",function()
  {
   return t$1.i;
  },function()
  {
   dispatch(Message.Remove);
  })),t$1)),(t.h.push(Handler.EventQ2(t.k,"startedit",function()
  {
   return t.i;
  },function()
  {
   dispatch(Message.StartEdit);
  })),t)),(p=Handler.CompleteHoles(b.k,b.h,[["iscompleted",2],["editingtask",0]]),(i=new TemplateInstance.New(p[1],WebSharper$Mvu$TodoMvc_Templates.entry(p[0])),b.i=i,i))).get_Doc();
 };
 ...
 {
  SC$2.$cctor();
  return SC$2.RenderedFullDocTemplate;
 };
 ...
 {
  SC$2.$cctor();
  SC$2.RenderedFullDocTemplate=$1;
 };
 ...
 SC$3.$cctor=function()
 {
  ...
  SC$3.EmptyAttr=null;
  SC$3.BoolCheckedApply=Runtime$1.Curried3(function(_var,el,cb)
  {
  ...
  SC$3.StringApply=(g=BindVar.StringGet(),(s=BindVar.StringSet(),Runtime$1.Curried(BindVar.ApplyValue,3,[g,function($1,$2)
  {
   return(s($1))($2);
  }])));
  ...
  SC$3.IntApplyUnchecked=(g$1=BindVar.IntGetUnchecked(),(s$1=BindVar.IntSetUnchecked(),Runtime$1.Curried(BindVar.ApplyValue,3,[g$1,function($1,$2)
  {
   return(s$1($1))($2);
  }])));
  ...
  SC$3.IntApplyChecked=(g$2=BindVar.IntGetChecked(),(s$2=BindVar.IntSetChecked(),Runtime$1.Curried(BindVar.ApplyValue,3,[g$2,function($1,$2)
  {
   return(s$2($1))($2);
  }])));
  ...
  SC$3.FloatApplyUnchecked=(g$3=BindVar.FloatGetUnchecked(),(s$3=BindVar.FloatSetUnchecked(),Runtime$1.Curried(BindVar.ApplyValue,3,[g$3,function($1,$2)
  {
   return(s$3($1))($2);
  }])));
  ...
  SC$3.FloatApplyChecked=(g$4=BindVar.FloatGetChecked(),(s$4=BindVar.FloatSetChecked(),Runtime$1.Curried(BindVar.ApplyValue,3,[g$4,function($1,$2)
  {
   return(s$4($1))($2);
  }])));
 };
