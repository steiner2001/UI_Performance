...
{
 "use strict";
 var PrettyTodo,Client,WebSharper,UI,Client$1,Templates,Obj,Doc,JavaScript,Pervasives,SC$1,Operators,EventTarget,Node,JS,Collections,Dictionary,Unchecked,Sitelets,RouterModule,List,T,Filter,ListModel,TodoItem,Router,Var$1,AttrModule,View,Var,Templating,Runtime,Server,TemplateInstance,Arrays,ProviderBuilder,Handler,todo_Templates,SC$2,HashSet,Seq,WindowOrWorkerGlobalScope,Docs,Router$1,Route,Storage,Numeric,ConcreteVar,Snap,Attrs,DomUtility,System,Guid,List$1,AttrProxy,Option,Event,UIEvent,Strings,DictionaryUtil,Object,Prepare,Slice,Enumerator,KeyCollection,DocElemNode,CharacterData,An,Settings,Abbrev,Mailbox,FSharpMap,ArrayStorage,Fresh,DynamicAttrNode,HtmlModule,attr,Array,TemplateInitializer,Attrs$1,Dyn,Docs$1,RunState,NodeSet,Concurrency,Anims,SC$3,BalancedTree,Tree,Pair,Map,Lazy,Utils,CheckedInput,T$1,BindVar,Elt,SC$4,SC$5,AppendList,LazyExtensionsProxy,LazyRecord,PathUtil,SC$6,SC$7,Updates,HashSetUtil,Scheduler,Easing,AsyncBody,SC$8,CT,HashSet$1,MapUtil,Queue,String,CancellationTokenSource,DomNodes,Char,ValueCollection,Error,OperationCanceledException,SC$9,IntelliFactory,Runtime$1,console,Math,Date;
 ...
 SC$1.$cctor=function()
 {
  ...
  function selected(e)
  {
   return AttrModule.DynamicClassPred("selected",View.Map(function(y)
   {
    return Unchecked.Equals(e,y);
   },filterVar.get_View()));
  }
  SC$1.Pages=RouterModule.Create(function(a)
  {
  ...
  {
   return todo.Id;
  },T.Empty),(filterVar=Router.Install(Filter.All,Client.Pages()),(todoVar=Var$1.Create$1(""),(allDoneVar=Var$1.Create$1(false),(notDone=Client.notDoneItemsCount(model),(allDone=View.Map(function(c)
  {
   return c===0;
 ...
 RouterModule.Create=function(ser,des)
 {
  return Router$1.New$1(function(path)
  {
   var m;
   m=des(path.Segments);
   return m==null?[]:[[Route.New(T.Empty,path.QueryArgs,path.FormData,path.Method,path.Body),m.$0]];
  },function(value)
  {
   return{
    $:1,
